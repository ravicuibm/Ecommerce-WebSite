...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <h3 class="w3-wide"><a href="index.php"><img id="logo" src="images/logo.png"  height="200" width="100%"/> </a></h3>
  </div> 
   <ul>
    
    <a href="#" class="w3-bar-item w3-button"><?php getCats(); ?></a>
    ...
    <h3><b>Brands</b></h3>
			...
			<ul id="cats">
					 ...
					 <a href="#" class="w3-bar-item w3-button"><?php getBrands(); ?></a>
